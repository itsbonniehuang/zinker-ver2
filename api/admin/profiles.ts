...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (!apiKey || !databaseId) {
    return res.status(400).json({ error: "Missing NOTION_API_KEY or NOTION_DATABASE_ID" });
  }
